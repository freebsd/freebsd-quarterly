...
* The results of link:https://ci.freebsd.org/job/FreeBSD-main-amd64-build[FreeBSD-main-amd64-build] and link:https://ci.freebsd.org/job/FreeBSD-main-amd64-test[FreeBSD-main-amd64-test] jobs are sending to link:https://lists.freebsd.org/subscription/dev-ci[dev-ci mailing list]
...
* The jobs for stable/11 branch are removed after September 30th per link:https://lists.freebsd.org/pipermail/freebsd-announce/2021-September/002060.html[FreeBSD 11.4 end-of-life]

Work in progress and open tasks:

* Designing and implementing pre-commit CI building and testing (to supoprt the link:https://gitlab.com/bsdimp/freebsd-workflow[workflow working group])
