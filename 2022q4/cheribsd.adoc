...
* An early research prototype of link:https://github.com/CTSRD-CHERI/cheripedia/wiki/Library-based-Compartmentalisation[library-based compartmentalisation], which implements an alternative run-time linker running shared objects in libraries.
