...
* Participated in the Open Source Voices Podcast - Episode to be aired in late April.
...
* New FreeBSD Journal Article: Contributing to FreeBSD ports with Git
  https://freebsdfoundation.org/wp-content/uploads/2022/04/Contributing-to-FreeBSD-Ports-with-Git.pdf
