...
After a recent system update with a GENERIC CURRENT configuration on my old
laptop with a Desktop environment without ZFS, the MIB has exceeded ten thousand
objects (both internal nodes and leaves, most in the vm.uma subtree).
