...
libglvnd (GL Vendor-Neutral Dispatch) "is a vendor-neutral dispatch layer for arbitrating OpenGL API calls
...
API call to at runtime.  Both GLX and EGL are supported, in any combination with OpenGL and OpenGL ES."
